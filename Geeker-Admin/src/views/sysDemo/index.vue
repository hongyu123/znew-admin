  ...
  <div class="table-box">
    <ProTable ref="proTable" title="系统示例表列表" :columns="columns" :requestApi="getTableList">
      ...
      <template #tableHeader="scope">
        <el-button type="primary" :icon="CirclePlus" @click="openEditForm('新增')" v-auth="['add']">新增xx</el-button>
        <el-button
          type="danger"
          :icon="Delete"
          plain
...
import EditModelForm from "@/views/sysDemo/edit.vue";
import { Delete, CirclePlus } from "@element-plus/icons-vue";
import { page, add, edit, del, dels } from "@/api/modules/sysDemo";
