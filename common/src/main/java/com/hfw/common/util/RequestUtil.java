...
public class RequestUtil {
    ...
    /**
     * 根据请求头判断是否是ajax请求
     * @param requestRequestJsonFilter
     * @return
     */
    public static boolean isJson(HttpServletRequest request) {
        ...
        return header!=null && header.indexOf("application/json")>-1;
    ...
    public static void json(HttpServletResponse response, Object obj) throws IOException {
        ...
        try(PrintWriter printWriter = response.getWriter()){
            printWriter.print(NullHandleObjectMapper.getInstance().writeValueAsString(obj));
        }
    }
