...
INSERT INTO `app_advice` VALUES (8,NULL,'产品建议','http://dummyimage.com/400x400','voluptate est','18175670489','2023-01-12 17:16:50',0),(9,7,'问题反馈','http://dummyimage.com/400x400','voluptate est','18175670489','2023-01-12 17:25:28',1);
...
INSERT INTO `app_article` VALUES (1,1,'用户协议','','',1,1,'',''),(2,1,'隐私政策','','',1,2,'',''),(3,1,'关于我们','','',1,3,'',''),(4,2,'1','http://127.0.0.1:8081/upload/202301/b4f49c5c-26f5-4ca1-9d15-d7d301ee0945.png','2',1,25,NULL,NULL);
...
INSERT INTO `app_user` VALUES (5,'farkle','/123','12345678902',NULL,NULL,NULL,0,0,1,1,NULL),(6,'nickname','/headimgurl',NULL,1,NULL,NULL,0,0,1,1,NULL),(7,'郑敏','http://dummyimage.com/100x100','18112518645',2,'2010-04-03','湖北省新余市万荣县',21,7,1,1,'123');
...
INSERT INTO `app_version` VALUES (1,1,'1','1','',0),(3,2,'3','3','',0),(4,1,'1.0','123456','http://rmm29sxv4.hn-bkt.clouddn.com/8cb992a6-905c-4925-9173-4d7b93d84325.apk',0),(5,2,'1.0','ios1.0',NULL,0),(6,1,'1','1','http://127.0.0.1:8081/upload/202301/d1b4b40b-c83c-4476-b1c5-60c1ab904b11.apk',1);
...
CREATE TABLE `sys_admin_log` (
  ...
  `response` varchar(2000) NULL COMMENT '响应',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='admin日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_auth` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统权限';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_demo` VALUES (1,'zzzzz',1,2.00,1,0,'[\"1\",\"2\"]',0,'2023-01-06','2023-01-05 13:36:25','http://127.0.0.1:8081/upload/202301/2a5d6385-ff47-4500-aba7-30a3dfb58b5e.png','','http://127.0.0.1:8081/upload/202301/13e5d7e8-e7e7-4c5f-a0b4-a93385f4b354.txt','简介','<p><span style=\"color: rgb(96, 98, 102); background-color: rgb(255, 255, 255); font-size: 14px;\">详情</span></p>','11111111111','云南省昆明市呈贡区七甸街道白泥洞',102.940364,24.927835,'http://127.0.0.1:8081/upload/202301/4bae2c0d-1f10-4b65-8fa1-a74fa1bc7e52.txt'),(2,'farkle',9,8.00,2,1,'[\"2\"]',1,'2023-01-11','2023-01-11 00:00:00','http://127.0.0.1:8081/upload/202301/61472aca-15d1-49a5-a04e-3174cf4a40e3.png',NULL,'http://127.0.0.1:8081/upload/202301/7195201d-6dfc-4640-91cf-a55e5516b117.txt','1','<p>2</p>','33333333333','云南省昆明市呈贡区七甸街道G78汕昆高速',102.885717,24.935197,'http://127.0.0.1:8081/upload/202301/51d6e555-ecda-4d4c-9c27-960afca8fc3b.txt'),(3,'fff',1,2.00,3,0,'[\"2\"]',1,'2023-02-01','2023-02-01 00:00:00','http://127.0.0.1:8081/upload/202301/5ed7fc91-03e9-40a7-8947-951d7e8b766c.png',NULL,'http://127.0.0.1:8081/upload/202301/75c992c6-a370-4b69-80f9-2e42f5fc2bcc.txt','1','<p>2</p>','33333333333','云南省昆明市官渡区太和街道站前路停车场(昆明铁路局计量所西)',102.719969,25.016006,'http://127.0.0.1:8081/upload/202301/a2c96972-188d-4c67-b97e-d5d27d4e79dc.txt');
...
CREATE TABLE `sys_login_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统登录日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sys_picture` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=56 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统图片';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_picture` VALUES (52,-1,'http://127.0.0.1:8081/upload/202301/93fafdfc-f5cd-4576-a631-2b85a9c37bda.png',1),(53,-1,'http://127.0.0.1:8081/upload/202301/3e943daf-e01d-446f-8dc3-3883eecb172a.png',1);
...
CREATE TABLE `sys_user` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(255) DEFAULT NULL COMMENT '备注',
  `merchant_flag` tinyint NOT NULL DEFAULT '0' COMMENT '是否商家账号',
  PRIMARY KEY (`id`),
...
INSERT INTO `sys_user` VALUES (1,'admin','$2a$10$IPnALJm4UjWekCNwlwNRq.lZSbjVS3YjH2gloSZVwr9aPq5g2OVAC','','系统管理员','','',1,1,1,'admin','2022-12-17 15:44:57','admin','2022-12-19 16:50:55','',0),(5,'test','$2a$10$ZCkxAyNnFAhP0Ulx5wQZ4e3WxQg61VvJHRGBEtjIaL/T8tsz1pzAO',NULL,NULL,NULL,NULL,NULL,1,0,'admin','2023-01-13 22:39:16',NULL,NULL,NULL,0);
...
-- Dump completed on 2023-01-14  0:53:18
