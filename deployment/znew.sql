-- public.sys_admin_log DDL
DROP TABLE IF EXISTS "public"."sys_admin_log";
CREATE TABLE "public"."sys_admin_log" (
...
-- public.sys_api_log DDL
DROP TABLE IF EXISTS "public"."sys_api_log";
CREATE TABLE "public"."sys_api_log" (
"id" int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY  (INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1),
"method" varchar(255) NOT NULL,
"user_id" int8,
"request_url" varchar(255) NOT NULL,
...
"id" int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY  (INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 70 CACHE 1),
...
-- public.sys_config DDL
DROP TABLE IF EXISTS "public"."sys_config";
CREATE TABLE "public"."sys_config" (
"id" int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY  (INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 2 CACHE 1),
"key" varchar(200) NOT NULL,
"value" varchar(255) NOT NULL,
"comment" varchar(255),
CONSTRAINT "sys_config_pkey" PRIMARY KEY ("id"));

-- public.sys_content DDL
DROP TABLE IF EXISTS "public"."sys_content";
CREATE TABLE "public"."sys_content" (
"id" int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY  (INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1),
"content" text NOT NULL,
CONSTRAINT "sys_content_pkey" PRIMARY KEY ("id"));

-- public.sys_data_scope DDL
DROP TABLE IF EXISTS "public"."sys_data_scope";
CREATE TABLE "public"."sys_data_scope" (
"id" int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY  (INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 4 CACHE 1),
...
"id" int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY  (INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 10 CACHE 1),
"name" varchar(50) NOT NULL,
"age" int4,
"score" numeric(10,2),
"gender" int2,
...
-- public.sys_dictionary DDL
DROP TABLE IF EXISTS "public"."sys_dictionary";
CREATE TABLE "public"."sys_dictionary" (
"id" int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY  (INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 5 CACHE 1),
...
-- public.sys_gen_column DDL
DROP TABLE IF EXISTS "public"."sys_gen_column";
CREATE TABLE "public"."sys_gen_column" (
"id" int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY  (INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 281 CACHE 1),
...
-- public.sys_gen_table DDL
DROP TABLE IF EXISTS "public"."sys_gen_table";
CREATE TABLE "public"."sys_gen_table" (
"id" int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY  (INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 19 CACHE 1),
"table_name" varchar(100) NOT NULL,
"table_remark" varchar(200),
CONSTRAINT "sys_gen_table_pkey" PRIMARY KEY ("id"));

-- public.sys_login_log DDL
...
-- public.sys_organization DDL
DROP TABLE IF EXISTS "public"."sys_organization";
CREATE TABLE "public"."sys_organization" (
"id" int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY  (INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 8 CACHE 1),
"pid" int8 NOT NULL DEFAULT 0,
...
"id" int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY  (INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 6 CACHE 1),
"name" varchar(50) NOT NULL,
"code" varchar(50),
"sort" int4,
"state" int2 NOT NULL,
...
-- public.sys_role_auth DDL
DROP TABLE IF EXISTS "public"."sys_role_auth";
CREATE TABLE "public"."sys_role_auth" (
"id" int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY  (INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 38 CACHE 1),
"role_id" int8 NOT NULL,
"auth_id" int8 NOT NULL,
CONSTRAINT "sys_role_auth_pkey" PRIMARY KEY ("id"));

-- public.sys_upload DDL
DROP TABLE IF EXISTS "public"."sys_upload";
CREATE TABLE "public"."sys_upload" (
"id" int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY  (INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 3 CACHE 1),
...
-- public.sys_user_role DDL
DROP TABLE IF EXISTS "public"."sys_user_role";
CREATE TABLE "public"."sys_user_role" (
"id" int8 NOT NULL GENERATED BY DEFAULT AS IDENTITY  (INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 25 CACHE 1),
"user_id" int8 NOT NULL,
"role_id" int8 NOT NULL,
CONSTRAINT "sys_user_role_pkey" PRIMARY KEY ("id"));

-- public.sys_admin_log Constraints
COMMENT ON TABLE "public"."sys_admin_log" IS 'admin日志';
COMMENT ON COLUMN "public"."sys_admin_log"."title" IS '标题';
COMMENT ON COLUMN "public"."sys_admin_log"."method" IS '方法名';
COMMENT ON COLUMN "public"."sys_admin_log"."account" IS '账号';
COMMENT ON COLUMN "public"."sys_admin_log"."request_url" IS '请求url';
COMMENT ON COLUMN "public"."sys_admin_log"."request_ip" IS '请求IP';
COMMENT ON COLUMN "public"."sys_admin_log"."request_body" IS '请求体';
COMMENT ON COLUMN "public"."sys_admin_log"."request_header" IS '请求头';
COMMENT ON COLUMN "public"."sys_admin_log"."response" IS '响应';
COMMENT ON COLUMN "public"."sys_admin_log"."state" IS '状态(1正常,0异常)';
COMMENT ON COLUMN "public"."sys_admin_log"."message" IS '异常信息';
COMMENT ON COLUMN "public"."sys_admin_log"."times" IS '耗时';
COMMENT ON COLUMN "public"."sys_admin_log"."request_time" IS '请求时间';

-- public.sys_api_log Constraints
COMMENT ON TABLE "public"."sys_api_log" IS '接口日志';
COMMENT ON COLUMN "public"."sys_api_log"."method" IS '方法名';
COMMENT ON COLUMN "public"."sys_api_log"."user_id" IS '用户id';
COMMENT ON COLUMN "public"."sys_api_log"."request_url" IS '请求url';
COMMENT ON COLUMN "public"."sys_api_log"."request_ip" IS '请求IP';
COMMENT ON COLUMN "public"."sys_api_log"."request_body" IS '请求体';
COMMENT ON COLUMN "public"."sys_api_log"."request_header" IS '请求头';
COMMENT ON COLUMN "public"."sys_api_log"."response" IS '响应';
COMMENT ON COLUMN "public"."sys_api_log"."state" IS '状态(1正常,0异常)';
COMMENT ON COLUMN "public"."sys_api_log"."message" IS '异常信息';
COMMENT ON COLUMN "public"."sys_api_log"."times" IS '耗时';
COMMENT ON COLUMN "public"."sys_api_log"."request_time" IS '请求时间';

-- public.sys_auth Constraints
COMMENT ON TABLE "public"."sys_auth" IS '系统权限';
COMMENT ON COLUMN "public"."sys_auth"."parent_id" IS '父id';
COMMENT ON COLUMN "public"."sys_auth"."title" IS '名称(菜单名)';
COMMENT ON COLUMN "public"."sys_auth"."code" IS '权限编码';
COMMENT ON COLUMN "public"."sys_auth"."name" IS '前端权限编码(路由名/按钮名)';
COMMENT ON COLUMN "public"."sys_auth"."auth_type" IS '权限类型(菜单,目录,按钮,权限)';
COMMENT ON COLUMN "public"."sys_auth"."sort" IS '排序';
COMMENT ON COLUMN "public"."sys_auth"."icon" IS '菜单图标';
COMMENT ON COLUMN "public"."sys_auth"."path" IS '路由地址';
COMMENT ON COLUMN "public"."sys_auth"."component" IS '组件路径';
COMMENT ON COLUMN "public"."sys_auth"."frame_flag" IS '是否外链';
COMMENT ON COLUMN "public"."sys_auth"."frame_url" IS '外链地址';
COMMENT ON COLUMN "public"."sys_auth"."cache_flag" IS '是否缓存';
COMMENT ON COLUMN "public"."sys_auth"."show_flag" IS '是否显示';
COMMENT ON COLUMN "public"."sys_auth"."state" IS '状态';
COMMENT ON COLUMN "public"."sys_auth"."create_user" IS '创建账号';
COMMENT ON COLUMN "public"."sys_auth"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."sys_auth"."update_user" IS '更新账号';
COMMENT ON COLUMN "public"."sys_auth"."update_time" IS '更新时间';
COMMENT ON COLUMN "public"."sys_auth"."remark" IS '备注';

-- public.sys_config Constraints
COMMENT ON TABLE "public"."sys_config" IS '系统配置';
CREATE UNIQUE INDEX "unique_key" ON "public"."sys_config" USING btree ("key" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS FIRST);
COMMENT ON COLUMN "public"."sys_config"."comment" IS '备注';

-- public.sys_content Constraints
COMMENT ON TABLE "public"."sys_content" IS '图文内容';
COMMENT ON COLUMN "public"."sys_content"."content" IS '图文详情';

-- public.sys_data_scope Constraints
COMMENT ON TABLE "public"."sys_data_scope" IS '数据权限表';
COMMENT ON COLUMN "public"."sys_data_scope"."config_type" IS '配置类型(1用户 2组织机构)';
COMMENT ON COLUMN "public"."sys_data_scope"."config_id" IS '用户/机构id';
COMMENT ON COLUMN "public"."sys_data_scope"."config_name" IS '用户/机构名称';
COMMENT ON COLUMN "public"."sys_data_scope"."data_key" IS '数据key';
COMMENT ON COLUMN "public"."sys_data_scope"."data_scope" IS 'enum_DataScope_数据权限';
COMMENT ON COLUMN "public"."sys_data_scope"."custom_ids" IS '自定义数据权限ids';

-- public.sys_demo Constraints
COMMENT ON TABLE "public"."sys_demo" IS '系统示例表';
COMMENT ON COLUMN "public"."sys_demo"."name" IS '名称(文本框)';
COMMENT ON COLUMN "public"."sys_demo"."age" IS '年龄(数字框)';
COMMENT ON COLUMN "public"."sys_demo"."score" IS '分数(小数)';
COMMENT ON COLUMN "public"."sys_demo"."gender" IS 'enum_Gender_性别(下拉框)';
COMMENT ON COLUMN "public"."sys_demo"."state" IS '启用状态(单选框)';
COMMENT ON COLUMN "public"."sys_demo"."interest" IS '兴趣(多选框)';
COMMENT ON COLUMN "public"."sys_demo"."deleted" IS '逻辑删除';
COMMENT ON COLUMN "public"."sys_demo"."birth" IS '生日(日期)';
COMMENT ON COLUMN "public"."sys_demo"."regist_time" IS '注册时间(日期时间)';
COMMENT ON COLUMN "public"."sys_demo"."avatar" IS '头像(图片上传)';
COMMENT ON COLUMN "public"."sys_demo"."video" IS '视频(视频上传)';
COMMENT ON COLUMN "public"."sys_demo"."photos" IS '照片(多图上传)';
COMMENT ON COLUMN "public"."sys_demo"."attachment" IS '附件(文件上传)';
COMMENT ON COLUMN "public"."sys_demo"."introduction" IS '简介(文本域)';
COMMENT ON COLUMN "public"."sys_demo"."detail" IS '详情(富文本)';
COMMENT ON COLUMN "public"."sys_demo"."phone" IS '手机';
COMMENT ON COLUMN "public"."sys_demo"."location" IS '地址';
COMMENT ON COLUMN "public"."sys_demo"."lng" IS '经度';
COMMENT ON COLUMN "public"."sys_demo"."lat" IS '纬度';
COMMENT ON COLUMN "public"."sys_demo"."file_input" IS '文件输入';

-- public.sys_dictionary Constraints
COMMENT ON TABLE "public"."sys_dictionary" IS '字典表';
CREATE UNIQUE INDEX "unique_dict_key" ON "public"."sys_dictionary" USING btree ("dict_key" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS FIRST);
COMMENT ON COLUMN "public"."sys_dictionary"."pid" IS '分类父id';
COMMENT ON COLUMN "public"."sys_dictionary"."leaf_flag" IS '叶子节点(叶子节点存字典值,非叶子节点存字典类别)';
COMMENT ON COLUMN "public"."sys_dictionary"."children_num" IS '子节点数量';
COMMENT ON COLUMN "public"."sys_dictionary"."state" IS 'enum_EnableState_状态';
COMMENT ON COLUMN "public"."sys_dictionary"."sort" IS '排序值';
COMMENT ON COLUMN "public"."sys_dictionary"."remark" IS '备注';
COMMENT ON COLUMN "public"."sys_dictionary"."create_user" IS '创建账号';
COMMENT ON COLUMN "public"."sys_dictionary"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."sys_dictionary"."update_user" IS '更新账号';
COMMENT ON COLUMN "public"."sys_dictionary"."update_time" IS '更新时间';

-- public.sys_gen_column Constraints
COMMENT ON TABLE "public"."sys_gen_column" IS '表单生成字段';
COMMENT ON COLUMN "public"."sys_gen_column"."table_name" IS '表名';
COMMENT ON COLUMN "public"."sys_gen_column"."column_name" IS '字段名';
COMMENT ON COLUMN "public"."sys_gen_column"."column_remark" IS '字段注释';
COMMENT ON COLUMN "public"."sys_gen_column"."label" IS '显示标题';
COMMENT ON COLUMN "public"."sys_gen_column"."property" IS '属性名';
COMMENT ON COLUMN "public"."sys_gen_column"."form_type" IS '表单类型';
COMMENT ON COLUMN "public"."sys_gen_column"."list_flag" IS '是否列表';
COMMENT ON COLUMN "public"."sys_gen_column"."search_flag" IS '是否搜索';
COMMENT ON COLUMN "public"."sys_gen_column"."required" IS '是否必填';
COMMENT ON COLUMN "public"."sys_gen_column"."maxlength" IS '字符串长度';

-- public.sys_gen_table Constraints
COMMENT ON TABLE "public"."sys_gen_table" IS '表单生成记录';
COMMENT ON COLUMN "public"."sys_gen_table"."table_name" IS '表名';
COMMENT ON COLUMN "public"."sys_gen_table"."table_remark" IS '表注释';

-- public.sys_login_log Constraints
COMMENT ON TABLE "public"."sys_login_log" IS '系统登录日志';
COMMENT ON COLUMN "public"."sys_login_log"."account" IS '用户账号';
...
COMMENT ON COLUMN "public"."sys_login_log"."state" IS '状态(1成功0失败)';
COMMENT ON COLUMN "public"."sys_login_log"."online_flag" IS '在线状态';
COMMENT ON COLUMN "public"."sys_login_log"."logout_type" IS '登出类型';
COMMENT ON COLUMN "public"."sys_login_log"."logout_time" IS '登出时间';

-- public.sys_organization Constraints
COMMENT ON TABLE "public"."sys_organization" IS '组织机构';
COMMENT ON COLUMN "public"."sys_organization"."pid" IS '父id';
COMMENT ON COLUMN "public"."sys_organization"."ancestors" IS '祖先路径';
COMMENT ON COLUMN "public"."sys_organization"."type" IS '类型(1组织机构,2部门)';
COMMENT ON COLUMN "public"."sys_organization"."name" IS '部门名称';
COMMENT ON COLUMN "public"."sys_organization"."sort" IS '显示顺序';
COMMENT ON COLUMN "public"."sys_organization"."link_name" IS '联系人';
COMMENT ON COLUMN "public"."sys_organization"."link_phone" IS '联系电话';
COMMENT ON COLUMN "public"."sys_organization"."link_email" IS '联系邮箱';
COMMENT ON COLUMN "public"."sys_organization"."state" IS 'enum_EnableState_状态';
COMMENT ON COLUMN "public"."sys_organization"."create_user" IS '创建账号';
COMMENT ON COLUMN "public"."sys_organization"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."sys_organization"."update_user" IS '更新账号';
COMMENT ON COLUMN "public"."sys_organization"."update_time" IS '更新时间';

-- public.sys_role Constraints
...
COMMENT ON COLUMN "public"."sys_role"."state" IS '状态';
COMMENT ON COLUMN "public"."sys_role"."system_flag" IS '是否系统内置';
COMMENT ON COLUMN "public"."sys_role"."remark" IS '备注';
COMMENT ON COLUMN "public"."sys_role"."create_user" IS '创建账号';
COMMENT ON COLUMN "public"."sys_role"."create_time" IS '创建时间';
COMMENT ON COLUMN "public"."sys_role"."update_user" IS '更新账号';
COMMENT ON COLUMN "public"."sys_role"."update_time" IS '更新时间';

-- public.sys_role_auth Constraints
COMMENT ON TABLE "public"."sys_role_auth" IS '系统角色-权限';
COMMENT ON COLUMN "public"."sys_role_auth"."role_id" IS '角色id';
COMMENT ON COLUMN "public"."sys_role_auth"."auth_id" IS '权限id';

-- public.sys_upload Constraints
COMMENT ON TABLE "public"."sys_upload" IS '系统文件上传';
COMMENT ON COLUMN "public"."sys_upload"."path" IS '文件路径';
COMMENT ON COLUMN "public"."sys_upload"."name" IS '文件名';
COMMENT ON COLUMN "public"."sys_upload"."file_suffix" IS '文件后缀';
COMMENT ON COLUMN "public"."sys_upload"."upload_time" IS '上传时间';
COMMENT ON COLUMN "public"."sys_upload"."file_size" IS '文件大小';

-- public.sys_user Constraints
COMMENT ON TABLE "public"."sys_user" IS '系统用户';
CREATE UNIQUE INDEX "unique_account" ON "public"."sys_user" USING btree ("account" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS FIRST);
COMMENT ON COLUMN "public"."sys_user"."account" IS '账号';
COMMENT ON COLUMN "public"."sys_user"."password" IS '密码';
COMMENT ON COLUMN "public"."sys_user"."org_id" IS '组织机构';
